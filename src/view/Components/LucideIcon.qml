...
Item {
    ...
    function getSvgSource(iconName, iconColor, iconSize) {
        var paths = {
            ...
            "arrow-down-right": "<path d='m6 9 6 6'/><path d='M4 4v7.5a.5.5 0 0 0 .5.5h7.5'/>",
            "arrow-down-left": "<path d='m18 9-6-6'/><path d='M20 4v7.5a.5.5 0 0 1-.5.5H4'/>",
            "arrow-up": "<path d='m12 19-7-7 7-7'/><path d='M19 12H5'/>",
